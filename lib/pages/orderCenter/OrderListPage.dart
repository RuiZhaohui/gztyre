...
class _OrderListPageState extends State<OrderListPage> {
  ...
  _listOrder(bool isManager) async {
    this._loading = true;
    this._list = [];
    return await HttpRequest.listOrder(
        this._userInfo.PERNR, this._userInfo.CPLGR, this._userInfo.MATYP, this._userInfo.SORTB, "X", null, Global.maintenanceGroup, (List<Order> list) {
